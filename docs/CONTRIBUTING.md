# Contributing to Goombay-rs

Thank you for your interest in contributing to Goombay-rs! We welcome contributions,
...
```nginx
git clone https://github.com/YOUR_USERNAME/goombay-rs.git
```

#### 4. Keep your fork up to date with the main branch

```nginx
# Add the main Goombay-rs repo as upstream
git remote add upstream https://github.com/lignum-vitae/goombay-rs.git
# Get latest changes
git fetch upstream
# Verify your remotes
git remote
...
```nginx
# Gets latest changes from main Goombay-rs project if you've set up an upstream branch as detailed above
git fetch upstream
...
from multiple areas within the Goombay-rs crate.
...
By contributing to Goombay-rs, you agree that your contributions will be licensed
under the MIT License, as outlined in the [LICENSE](https://github.com/lignum-vitae/goombay-rs/blob/main/LICENSE)
file.
...
Thank you for contributing to Goombay-rs! Your help improves the project for everyone!
